...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.StartDate = field.NewTime(tableName, "StartDate")
	_project.EndDate = field.NewTime(tableName, "EndDate")
	_project.CompanyID = field.NewInt32(tableName, "CompanyId")
...
func (p *project) updateTableName(table string) *project {
	...
	p.EndDate = field.NewTime(table, "EndDate")
	p.CompanyID = field.NewInt32(table, "CompanyId")
...
func (p *project) fillFieldMap() {
	...
	p.fieldMap["EndDate"] = p.EndDate
	p.fieldMap["CompanyId"] = p.CompanyID
}
