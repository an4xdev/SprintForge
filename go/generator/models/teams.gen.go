...
func newTeam(db *gorm.DB, opts ...gen.DOOption) team {
	...
	_team.ManagerID = field.NewString(tableName, "ManagerId")
	_team.ProjectID = field.NewString(tableName, "ProjectId")
...
func (t *team) updateTableName(table string) *team {
	...
	t.ManagerID = field.NewString(table, "ManagerId")
...
func (t *team) fillFieldMap() {
	...
	t.fieldMap["ManagerId"] = t.ManagerID
