...
func newTask(db *gorm.DB, opts ...gen.DOOption) task {
	...
	_task.TaskTypeID = field.NewInt32(tableName, "TaskTypeId")
	_task.TaskStatusID = field.NewInt32(tableName, "TaskStatusId")
	_task.DeveloperID = field.NewString(tableName, "DeveloperId")
	_task.SprintID = field.NewString(tableName, "SprintId")
	_task.ProjectID = field.NewString(tableName, "ProjectId")
...
type task struct {
	...
	TaskTypeID   field.Int32
	TaskStatusID field.Int32
	DeveloperID  field.String
	SprintID     field.String
...
func (t *task) updateTableName(table string) *task {
	...
	t.TaskTypeID = field.NewInt32(table, "TaskTypeId")
	t.TaskStatusID = field.NewInt32(table, "TaskStatusId")
	t.DeveloperID = field.NewString(table, "DeveloperId")
	t.SprintID = field.NewString(table, "SprintId")
	t.ProjectID = field.NewString(table, "ProjectId")
...
func (t *task) fillFieldMap() {
	...
	t.fieldMap["TaskTypeId"] = t.TaskTypeID
	t.fieldMap["TaskStatusId"] = t.TaskStatusID
	t.fieldMap["DeveloperId"] = t.DeveloperID
	t.fieldMap["SprintId"] = t.SprintID
	t.fieldMap["ProjectId"] = t.ProjectID
}
